...
for label in ax.get_xticklabels(which='major'):    label.set(rotation=0, horizontalalignment='center')
...
ax1.set_ylabel('Number of occurency', fontsize = 10, family='sans', weight='semibold')
